...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BusinessBusinessProps', function() {
      beforeEach(function() {
        instance = new OrdersApi.BusinessBusinessProps();
      });

      it('should create an instance of BusinessBusinessProps', function() {
        // TODO: update the code to test BusinessBusinessProps
        expect(instance).to.be.a(OrdersApi.BusinessBusinessProps);
      });
