...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BusinessProps', function() {
      beforeEach(function() {
        instance = new OrdersApi.BusinessProps();
      });

      it('should create an instance of BusinessProps', function() {
        // TODO: update the code to test BusinessProps
        expect(instance).to.be.a(OrdersApi.BusinessProps);
      });
